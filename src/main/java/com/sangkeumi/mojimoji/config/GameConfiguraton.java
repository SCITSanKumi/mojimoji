...
public class GameConfiguraton {
    ...
    public GameConfiguraton() {
        ...
        """
            ...
            {"name":"퇴역 용사2"} 식료품점, 무기점, 신전, 여관, 용병훈련소 등 여러 장소에 가셔서 필요한 미션을 수행하는 걸 추천해 드립니다.
            {"name":"narration"} 용사여, 이제 당신은 마왕성으로의 여정을 시작하면 됩니다.
            퇴역 용사들의 조언을 참고하되 한자가 포함된 한국어, 일본어 문장을 입력해 마왕성으로의 여정을 스스로 설계해 보세요.
        ...
        ⓗ용사가 입력한 문장의 문법/문장을 체크해주는 기능

        ★★1. 용사가 입력한 문법과 문장에 치명적인 오류가 있거나, 맥락을 너무 벗어나는 경우 당신은 다음 스토리를 생성하기 전 문장을 간단히 교정해줘야 합니다. 그런 다음 용사에게 문장을 다시 입력해달라고 언급해야 합니다★★
        ★★2. 용사가 문장을 입력할 때마다 문장을 교정하면 스토리의 진행이 끊기니까, 사소한 것에는 개입하지 마세요. 완벽한 문장을 10이라 하고, 완전히 틀린 문장을 0이라고 가정할 때, 용사가 입력한 문장이 4이하일 때만 교정해주세요★★
        ★★3. 아래 예시에서 용사가 입력하는 문장(①, ②, ③ 등의 숫자)에 대해 문법 체크를 해야 할 상황의 예시입니다.


               ***문장 체크를 해야 할 상황: ⓓ스토리의 세계관과 구조와 연결짓기가 어려운 문장을 입력했을 경우***
               ⑥ 私は株に投資しています
                {name": "문법 체크"} 현재 스토리에서 주식 투자는 맥락에 적합하지 않습니다. 다른 문장을 입력해주세요.
