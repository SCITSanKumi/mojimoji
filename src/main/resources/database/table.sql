...
CREATE TABLE `Users` (
    ...
    `status` ENUM('active', 'inactive', 'banned', 'pending', 'deleted') NOT NULL,
...
CREATE TABLE `Kanjis` (
    ...
    `jlpt_rank` VARCHAR(10) NULL,
    `category` VARCHAR(20) NULL,
    `kanji` VARCHAR(4) NOT NULL,
    `kor_onyomi` VARCHAR(20) NULL,
    `kor_kunyomi` VARCHAR(20) NULL,
    `jpn_onyomi` VARCHAR(20) NULL,
    `jpn_kunyomi` VARCHAR(20) NULL,
    `meaning` VARCHAR(2000) NULL,
